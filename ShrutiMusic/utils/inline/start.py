...
def start_panel(_):
    buttons = [
        ...
        [
            InlineKeyboardButton(text=f"✨ {_['S_B_11']}", callback_data="about_page"),
        ],
    ]
    return buttons
...
def private_panel(_):
    buttons = [
        ...
        [
            InlineKeyboardButton(text=f"🎗️ {_['S_B_11']}", callback_data="about_page"),
            InlineKeyboardButton(text=f"👑 {_['S_B_12']}", callback_data="owner_page"),
        ],
        [
            InlineKeyboardButton(text=f"🍁 {_['E_X_1']}", callback_data="fork_repo"),
...
def about_panel(_):
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text=f"🔙 {_['BACK_BUTTON']}", callback_data="settingsback_helper"
            )
        ],
    ]
    return buttons
